...
@endif
@if($lot->cur_status == config('payment_lot.status.sbi.signed'))
...
@endif
@if($lot->cur_status == config('payment_lot.status.common.response'))
...
@endif
@if(in_array($lot->cur_status, [config('payment_lot.status.common.generated'), config('payment_lot.status.sbi.signed')]))
