...
>
    ...
    <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <!-- Payments -->
        <div x-data="{ open: {{ request()->routeIs('admin.payment-lot-generation', 'admin.payment-lot-transaction', 'admin.block-unblock-payment', 'admin.map-financial-year', 'admin.payment-lot-settings', 'admin.validation-lot-settings', 'admin.sbi-payment-settings', 'admin.ifms-payment-settings') ? 'true' : 'false' }} }">
            <button @click="open = !open" class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.payment-lot-generation', 'admin.payment-lot-transaction', 'admin.block-unblock-payment', 'admin.map-financial-year', 'admin.payment-lot-settings', 'admin.validation-lot-settings', 'admin.sbi-payment-settings', 'admin.ifms-payment-settings') ? 'bg-slate-800/50 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                <div class="flex items-center">
            ...
            <div x-show="open" x-collapse class="pl-11 pr-3 py-1 space-y-1">
                ...
                <a href="{{ route('admin.payment-lot-transaction') }}" wire:navigate class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('admin.payment-lot-transaction') ? 'bg-amber-500 text-white font-medium shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800' }}">Lot Transaction</a>
                ...
                <a href="{{ route('admin.ifms-payment-settings') }}" wire:navigate class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('admin.ifms-payment-settings') ? 'bg-amber-500 text-white font-medium shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800' }}">IFMS Payment Setting</a>
            </div>
        </div>
        
        <!-- Submenu Example: Settings -->
        <div x-data="{ open: {{ request()->routeIs('admin.payment-main-settings') ? 'true' : 'false' }} }">
            <button @click="open = !open" class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.payment-main-settings') ? 'bg-slate-800/50 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                <div class="flex items-center">
            ...
            <div x-show="open" x-collapse class="pl-11 pr-3 py-1 space-y-1">
                ...
                <a href="{{ route('admin.payment-main-settings') }}" wire:navigate class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('admin.payment-main-settings') ? 'bg-amber-500 text-white font-medium shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800' }}">Payment</a>
            </div>
        </div>
    </div>
</aside>
