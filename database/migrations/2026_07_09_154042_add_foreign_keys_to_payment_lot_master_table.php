...
return new class extends Migration
{
    ...
    {
        Schema::table('payment_lot_master', function (Blueprint $table) {
            ...
            $table->foreign(['lot_type_id'], 'fk_payment_lot_master_lot_type_id')->references(['id'])->on('codemasters')->onUpdate('no action')->onDelete('no action');
            $table->foreign(['lot_month'], 'fk_payment_lot_master_month')->references(['code'])->on('months')->onUpdate('no action')->onDelete('no action');
            $table->foreign(['payment_mode'], 'fk_payment_lot_master_payment_mode')->references(['id'])->on('codemasters')->onUpdate('no action')->onDelete('no action');
    ...
    public function down(): void
    {
        Schema::table('payment_lot_master', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_payment_lot_master_lot_type_id');
            $table->dropForeign('fk_payment_lot_master_month');
            $table->dropForeign('fk_payment_lot_master_payment_mode');
