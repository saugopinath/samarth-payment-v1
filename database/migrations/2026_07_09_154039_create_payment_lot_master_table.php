...
return new class extends Migration
{
    ...
    {
        Schema::create('payment_lot_master', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->timestamp('payment_push_date')->nullable();
            ...
            $table->decimal('total_amount', 13, 0)->nullable()->default(0);
            $table->decimal('success_amount', 13, 0)->nullable()->default(0);
            $table->decimal('failed_amount', 13, 0)->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('payment_lot_master');
    }
};
