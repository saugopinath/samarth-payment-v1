            ...
            for ($i = 0; $i < 600; $i++) {
                ...
                */
                ...
                $beneficiary = BeneficiaryPersonalDetail::updateOrCreate([
                    ...
                    'created_by_local_body_code' => $block_id,
                ]);
                ...
                if ($unique && $beneficiary_aadhar && $beneficiary && $beneficiary_contact && $beneficiary_bank && $beneficiary_enclosure && $beneficiary_self_declaration) {
                    DB::commit();
                } else {
                    DB::rollBack();
