...
class PurbaMedinipur extends Seeder
{
     /**
    ...
    public function run()
    {
         ...
         $list = array(
            ...
            array(
                'name' => 'Kolaghat Block Office',
                'address' => 'Kolaghat Block  Office',
                'zip' => NULL,
            ...
            array(
                'name' => 'Tamluk Sub Division Office',
                'address' => 'Tamluk Sub Division Office',
                'zip' => NULL,
